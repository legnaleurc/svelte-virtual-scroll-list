...
class Item extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$7, create_fragment$7, safe_not_equal, { horizontal: 1, uniqueKey: 2, type: 3 });
	}
}
...
function create_if_block_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*$$scope, displayItems*/ 268435464) {
...
// (195:8) <Item on:resize={onItemResized} type="slot" uniqueKey="header">
function create_default_slot_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (header_slot) {
				if (header_slot.p && (!current || dirty[0] & /*$$scope, displayItems*/ 268435464)) {
...
// (201:12) <Item                     on:resize={(e) => onItemResized(e.detail)}                     uniqueKey={data[key]}                     horizontal={isHorizontal}                     type="item">
function create_default_slot_1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && (!current || dirty[0] & /*$$scope, displayItems*/ 268435464)) {
...
// (200:8) {#each displayItems as data}
function create_each_block$2(ctx) {
	...
	item.$on("resize", /*resize_handler*/ ctx[25]);
...
// (211:8) <Item on:resize={onItemResized} type="slot" uniqueKey="footer">
function create_default_slot$4(ctx) {
	let current;
	const footer_slot_template = /*#slots*/ ctx[24].footer;
	...
	return {
		...
		p(ctx, dirty) {
			if (footer_slot) {
				if (footer_slot.p && (!current || dirty[0] & /*$$scope, displayItems*/ 268435464)) {
...
function create_fragment$6(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*displayItems, key, isHorizontal, onItemResized, $$scope*/ 268435595) {
...
/* test/TestItem.svelte generated by Svelte v3.38.2 */

function create_fragment$5(ctx) {
	let div;
	let t0_value = /*data*/ ctx[0].uniqueKey + "";
	let t0;
	let t1;
	let t2_value = /*data*/ ctx[0].height + "";
	let t2;
	let t3;
	...
	return {
		c() {
			...
			t2 = text(t2_value);
			t3 = text("px)");
			set_style(div, "height", /*data*/ ctx[0].height + "px");
			attr(div, "class", "svelte-15use0m");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, t0);
		...
		p(ctx, [dirty]) {
			if (dirty & /*data*/ 1 && t0_value !== (t0_value = /*data*/ ctx[0].uniqueKey + "")) set_data(t0, t0_value);
			if (dirty & /*data*/ 1 && t2_value !== (t2_value = /*data*/ ctx[0].height + "")) set_data(t2, t2_value);
...
/* test/SimpleList.svelte generated by Svelte v3.38.2 */
...
// (37:4) <VirtualScroll             bind:this={list}             data={items}             key="uniqueKey"             let:data             on:bottom={() => addNotification("bottom")}             on:top={() => addNotification("top")}     >
function create_default_slot$3(ctx) {
	let testitem;
	let current;
	testitem = new TestItem({ props: { data: /*data*/ ctx[16] } });
	...
	return {
		...
		p(ctx, dirty) {
			const testitem_changes = {};
			if (dirty & /*data*/ 65536) testitem_changes.data = /*data*/ ctx[16];
...
// (64:4) {#each Object.entries(notifications) as [id, action] (id)}
function create_each_block$1(key_1, ctx) {
	let div;
	let t0_value = /*action*/ ctx[13] + "";
	let t0;
	let t1;
	let rect;
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*notifications*/ 4 && t0_value !== (t0_value = /*action*/ ctx[13] + "")) set_data(t0, t0_value);
		},
		r() {
...
function create_fragment$4(ctx) {
	...
	/*virtualscroll_binding*/ ctx[5](virtualscroll);
	virtualscroll.$on("bottom", /*bottom_handler*/ ctx[6]);
	virtualscroll.$on("top", /*top_handler*/ ctx[7]);
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(button0, "click", /*addItems*/ ctx[3]),
					...
					listen(button3, "click", /*click_handler_1*/ ctx[9])
				];
		...
		d(detaching) {
			...
			/*virtualscroll_binding*/ ctx[5](null);
...
/* test/InfiniteList.svelte generated by Svelte v3.38.2 */

function create_default_slot$2(ctx) {
	let testitem;
	let current;
	testitem = new TestItem({ props: { data: /*data*/ ctx[10] } });
	...
	return {
		...
		p(ctx, dirty) {
			const testitem_changes = {};
			if (dirty & /*data*/ 1024) testitem_changes.data = /*data*/ ctx[10];
			testitem.$set(testitem_changes);
		},
		i(local) {
			if (current) return;
...
/* test/PageList.svelte generated by Svelte v3.38.2 */
...
function instance$2($$self, $$props, $$invalidate) {
	...
	return [items, list, addItems, virtualscroll_binding, click_handler, click_handler_1];
}
...
/* test/ChangeableData.svelte generated by Svelte v3.38.2 */

function create_default_slot(ctx) {
	let testitem;
	let current;
	testitem = new TestItem({ props: { data: /*data*/ ctx[8] } });
	...
	return {
		...
		p(ctx, dirty) {
			const testitem_changes = {};
			if (dirty & /*data*/ 256) testitem_changes.data = /*data*/ ctx[8];
			testitem.$set(testitem_changes);
		},
		i(local) {
			if (current) return;
...
/* test/App.svelte generated by Svelte v3.38.2 */
...
function create_each_block(ctx) {
	...
	return {
		c() {
			span = element("span");
			t = text(t_value);
			attr(span, "class", "page-selector svelte-1xewpri");
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "page-selector-container svelte-1xewpri");
			attr(main, "class", "svelte-1xewpri");
		},
		m(target, anchor) {
