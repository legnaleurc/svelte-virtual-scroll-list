...
// (34:4) <VirtualScroll             bind:this={list}             data={items}             key="uniqueKey"             let:data             on:bottom={() => addNotification("bottom")}             on:top={() => addNotification("top")}     >
function create_default_slot$4(ctx) {
	let testitem;
	let current;
	const testitem_spread_levels = [/*data*/ ctx[16]];
	let testitem_props = {};
	...
	return {
		...
		p(ctx, dirty) {
			const testitem_changes = (dirty & /*data*/ 65536)
			? get_spread_update(testitem_spread_levels, [get_spread_object(/*data*/ ctx[16])])
			: {};
...
// (60:4) {#each Object.entries(notifications) as [id, action] (id)}
...
function create_fragment$5(ctx) {
	...
	return {
		c() {
			...
			button0.textContent = "Add 10 to bottom";
			t2 = space();
			button1 = element("button");
			button1.textContent = "To bottom";
			t4 = space();
			button2 = element("button");
			button2.textContent = "Add 1 and scroll to bottom";
			t6 = space();
			div1 = element("div");
...
/* test/SimpleListStore.svelte generated by Svelte v3.38.2 */
...
function instance$3($$self, $$props, $$invalidate) {
	...
	function addItems(top = true, count = 10) {
		...
		} else $$invalidate(0, items = [...items, ...new_items]);
	}
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			t3 = space();
			button2 = element("button");
			button2.textContent = "To top";
			t5 = space();
			button3 = element("button");
			button3.textContent = "To bottom";
			t7 = space();
			button4 = element("button");
			button4.textContent = "Add 1 and scroll to bottom";
			t9 = space();
			div1 = element("div");
			create_component(virtualscroll.$$.fragment);
			attr(div0, "class", "overflow-buttons svelte-1uyby34");
			attr(div1, "class", "vs");
		},
		m(target, anchor) {
			insert(target, div0, anchor);
			...
			if (!mounted) {
				dispose = [
					...
					listen(button2, "click", /*click_handler_1*/ ctx[4]),
...
function instance$2($$self, $$props, $$invalidate) {
	...
	const click_handler = () => addItems(false);
	const click_handler_1 = () => list.scrollToOffset(0);
